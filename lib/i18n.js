...
const LOCALE_ALIASES = {
    'pt': 'pt-BR', 'pt-br': 'pt-BR', 'pt_br': 'pt-BR', 'portuguese': 'pt-BR', 'português': 'pt-BR',
    'en': 'en', 'en-us': 'en', 'english': 'en',
    'es': 'es', 'es-es': 'es', 'spanish': 'es', 'español': 'es'
};
...
const messages = {
    'pt-BR': {
        ...
        languageUsage: 'Uso: {prefix}idioma <pt-br|en|es>', languageChanged: 'Idioma alterado para {language}.',
    ...
    en: {
        ...
        languageUsage: 'Usage: {prefix}language <pt-br|en|es>', languageChanged: 'Language changed to {language}.',
