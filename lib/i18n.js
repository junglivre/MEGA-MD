...
const messages = {
    'pt-BR': {
        ...
        descriptions: { menu: 'Mostra todos os comandos', help: 'Mostra todos os comandos', idioma: 'Escolhe o idioma usado pelo bot', language: 'Escolhe o idioma usado pelo bot', alive: 'Verifica o status e as informações do sistema', owner: 'Mostra o contato do proprietário do bot', chatbot: 'Ativa ou desativa o chatbot de IA do grupo', calc: 'Calculadora avançada', translate: 'Traduz um texto para o idioma escolhido', sticker: 'Cria ou edita uma figurinha a partir de imagem, vídeo, GIF ou outra figurinha' },
    ...
    en: {
        ...
        genericDescription: 'Executes the {command} command.', descriptions: {},
        p: pluginMessages.en
    },
    es: {
