    ...
    async handler(sock, message, args, context) {
        ...
        try {
            if (action === 'criar' || action === 'create') {
                const bank = createBank(state, rest.trim(), senderId);
            ...
            const errorKey = {
                invalid_name: 'invalidName', already_exists: 'alreadyExists', not_found: 'notFound',
                invalid_keywords: 'invalidKeywords', invalid_context: 'invalidContext', limit_reached: 'limitReached',
                joke_not_found: 'jokeNotFound', invalid_group: 'invalidGroup', group_not_linked: 'groupNotLinked'
