...
export default {
    ...
    async handler(sock, message, args, context) {
        ...
        if (!query) {
            return sock.sendMessage(chatId, { text: `🤖 *${t('p.mistral.title')}*\n\n${t('p.mistral.usage')}` }, { quoted: message });
        }
        try {
            ...
            await sock.sendMessage(chatId, { text: `❌ ${t('p.mistral.failed')}` }, { quoted: message });
        }
    }
};
